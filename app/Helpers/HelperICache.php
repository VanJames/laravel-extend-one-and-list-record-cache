...
interface HelperICache
{
	 ...
	 * @return	boolean
	 */
	public function put( $key , $value = null , $expire = 0 , $flag = 0 , $serverId = false );
	 ...
	 * @return	mixed
	 */
	public function get( $key , $serverId = false , $isOld = false );
	 ...
	 * @return	boolean
	 */
	public function forget( $key , $time_out = 0 , $serverId = false , $isOld = false );
	 ...
	 * @return	boolean
	 */
	public function flush( $serverId = false );
